#!/bin/bash
# ******************************************************************************
# This is a lifecycle-bash script, executed AFTER each startup of the WebLogic
# admin server.
#
...
# bash script.
#
# Be warned that the commands in this file will be executed repetitively after
# each server startup.
#
